# DSA in Python – Striver A2Z Sheet

Welcome to my journey of mastering **Data Structures and Algorithms in Python**!  
I'm following the famous [Striver A2Z DSA Sheet](https://takeuforward.org/strivers-a2z-dsa-course/strivers-a2z-dsa-course-sheet-2/) and solving every problem in Python — documenting it all right here in this repo.
